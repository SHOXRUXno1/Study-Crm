  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "appearance-none bg-background border border-input rounded-md text-sm font-medium px-2.5 py-1 cursor-pointer focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 hover:bg-accent transition-colors",
